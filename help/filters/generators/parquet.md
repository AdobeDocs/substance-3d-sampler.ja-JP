---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-sampler/filters/generators/parquet.html"
breadcrumb-title: ''
description: Substance 3D Samplerの寄木細工ジェネレーターを使用して、マテリアルにリアルな寄木細工のフローリングパターンとテクスチャを作成します。
...
* **縫い目の強度**: 0 ～ 1\
  板の間の縫い目の法線を調整して、目立たせたり目立たなくしたりします
* **縫い目のベベル曲線**: 0-1\
  床板間のベベルの幅を変更
* **縫い目のHeight範囲**: 0 ～ 1\
  縫い目のHeightを調整する
