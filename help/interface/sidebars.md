...
breadcrumb-title: ''
description: Substance 3D Samplerのインターフェイスでツール、パネル、アプリケーション機能を切り替えるための左右のサイドバーについて説明します。
...
* レイヤースタックにすばやくフィルターを追加します。
  * **切り抜き：** **2Dビュー**&#x200B;のハンドルを使用して画像や素材を切り抜きます。
  * **遠近法の変換：** **2Dビューのハンドルを使用して遠近法のエラーを修正します。**
  * **変形：** **2Dビューのハンドルを使用して、画像やマテリアルのサイズを変更します。**
  * **コピースタンプ:** **2Dビュー**&#x200B;の領域をペイントして、継ぎ目やその他の問題を修正します。
* 次のパネルを閉じたときに再度開く：
