...
HP Z Captisは、Adobe Substance 3D Samplerによってネイティブに接続および操作されるマテリアルキャプチャデバイスです。 Substance 3D SamplerをHP Z Captisと統合すると、キャプチャのプレビューと起動、PBRチャンネルの自動処理、デジタルマテリアルの書き出しを行うことができます。

HP Z CaptisのサポートがSamplerのメインビルドに統合され、Enterprise、Teams、Universityライセンスで利用できるようになりました。
